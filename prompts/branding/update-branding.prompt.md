...
**Target Directory:** `src/app/(dashboard)/dashboard/layout/shared/logo/`
**Action:**
...
**Target File:** `src/app/(dashboard)/dashboard/layout/footer/page.tsx`
**Action:**
...
<p className="text-sm text-muted-foreground">
  © 2026 by{" "}
  <Link
    href="https://www.{{NEW_COMPANY_NAME_LOWER}}.com/" target="_blank"
...
**Target Directory:** `src/app/(dashboard)/dashboard/layout/shared/`
**Action:**
...
**Target Directory:** `src/app/(dashboard)/dashboard/`
**Action:**
...
- [ ] `src/app/(dashboard)/dashboard/layout/shared/logo/logo.tsx` - Logo alt text updated
- [ ] `src/app/(dashboard)/dashboard/layout/shared/logo/full-logo.tsx` - Logo alt text updated
- [ ] `src/components/dashboard/shared/` - Footer copyright updated
