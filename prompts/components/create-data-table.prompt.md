...
1. **Separation of Concerns (IMPORTANT)**:
   ...
   * The reusable **Table Component** MUST be created inside `src/components/dashboard/react-tables/...`.
   * The **Page Route** MUST be created inside `src/app/(dashboard)/dashboard/react-tables/...`.
...
* Scan: `src/components/dashboard/react-tables/**`
...
`src/app/(dashboard)/dashboard/layout/vertical/sidebar/sidebaritems.ts`
...
`src/app/(dashboard)/dashboard/layout/horizontal/menudata.ts`
