...
- **Component Path**: `{{COMPONENT_PATH}}` (e.g., src/components/dashboard/dashboards/analytics/total-visits.tsx)
...
> **Path**: `src/components/dashboard/dashboards/general/small-charts.tsx`
