...
- **Directory Path:** `{{DIR_PATH}}` (e.g., src/app/(dashboard)/dashboard/dashboards/sales/)
  ...
  return (
    ...
    <div className="grid grid-cols-12 gap-4">
      ...
      <div className="col-span-12">
        ...
        <p className="text-muted-foreground mt-1">Welcome to the {{PAGE_NAME}} module.</p>
...
**Target File:** `src/app/(dashboard)/dashboard/layout/vertical/sidebar/sidebaritems.ts`
...
**Target File:** `src/app/(dashboard)/dashboard/layout/horizontal/menudata.ts`
