              ...
              <div className="flex mt-3 items-center justify-between">
                ...
                <div className="flex">
                  <button
                    ...
                    className="w-5 h-5 bg-primary/12 hover:bg-primary hover:text-white text-primary flex cursor-pointer justify-center items-center rounded-l-md"
                  >
                  ...
                  <button
                    ...
                    className="w-5 h-5 bg-primary/12 text-primary hover:bg-primary hover:text-white flex cursor-pointer justify-center items-center rounded-r-md"
                  >
