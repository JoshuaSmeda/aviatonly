    ...
    return (
      <div className="w-full text-center p-5">
        <div className="px-6 pt-3">
          <h1 className="text-xl"> Please Select a Email</h1>
        </div>
        <Image
              ...
              <TooltipProvider>
                <div className="flex items-center gap-2 py-4 px-5">
                  ...
                  <Tooltip>
                    <TooltipTrigger>
                      <div
                        className="btn-circle-hover  group"
                    ...
                    <TooltipTrigger>
                      <div className="btn-circle-hover  group">
                        <Icon
                          ...
                          className={`group-hover:text-primary ${selectedEmail.important ? "text-chart-3 " : ""
                            }`}
                          height={18}
                  ...
                  <Tooltip>
                    <TooltipTrigger>
                      <div className="btn-circle-hover  hover:text-destructive hover:bg-destructive/12">
                        <Icon
                          icon="tabler:trash"
                          height={18}
            ...
            <SimpleBar className="h-[calc(100vh-200px)]">
              <div className="py-5 px-5">
                <div className="flex items-center w-full">
                  ...
                  <div>
                    <Badge
                      className={`rounded-md ${selectedEmail.label === "Promotional"
                        ? "bg-primary "
                ...
                <div className="mt-8">
                  ...
                  <div
                    className="email-content my-3.5"
              ...
              <div className="px-5">
                <div className="flex gap-6">
                  <span
                    className="cursor-pointer text-sm hover:text-primary  flex items-center"
                  ...
                  <span className="cursor-pointer hover:text-primary text-sm  flex items-center">
                    <Icon
                ...
                {isTextboxVisible && (
                  <Textarea className=" mt-4" required rows={4} />
                )}
              </div>
            </SimpleBar>
          </div>
