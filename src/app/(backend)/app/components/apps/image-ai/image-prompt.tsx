...
function ImagePrompt() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h2 className="text-2xl font-medium mb-1">AI image generator</h2>
      ...
      <div>
        <Card className="p-4">
          <div>
            ...
            <Textarea
              className=" p-1 border-none resize-none"
          ...
          <div className="flex flex-col gap-6">
            <div className="inline-flex flex-wrap gap-2">
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger>
                    <div
                      onClick={handleClick}
                      className="w-10 h-10 border rounded-md flex items-center justify-center cursor-pointer hover:border-primary  hover:text-primary "
                    >
                      <Icon
              ...
              {[
                ...
                <div
                  key={index}
                  className="border p-3 h-10 rounded-md hover:border-primary  hover:text-primary flex items-center"
                >
                  <DropdownMenu>
                    <DropdownMenuTrigger>
