...
const EditInvoicePage = () => {
  ...
  const statusBadgeColorMap: Record<string, string> = {
    Paid: "bg-chart-2/12 text-chart-2",
  ...
  return (
    <div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger>
                <div
                  ...
                  className="border border-border  flex justify-center items-center px-3 py-1 rounded cursor-pointer"
                >
                  <Badge
                    className={
                      statusBadgeColorMap[editedInvoice.status] ||
            ...
            <div className="py-5">
              ...
              <Popover>
                <PopoverTrigger className={"w-full"}>
                  <Button
                    variant="outline"
                    className={` w-full justify-start text-left font-normal border border-border hover:bg-transparent hover:border-primary text-muted-foreground`}
                  >
      ...
      <div className="p-4 bg-muted dark:bg-muted/50 border border-border rounded-xl flex flex-col gap-1 mb-10">
