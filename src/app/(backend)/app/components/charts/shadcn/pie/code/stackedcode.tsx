...
const desktopData = [
  ...
  { month: "march", desktop: 237, fill: "var(--color-chart-4)" },
  { month: "april", desktop: 173, fill: "var(--color-destructive)" },
...
const mobileData = [
  ...
  { month: "march", mobile: 120, fill: "var(--color-chart-4)" },
  { month: "april", mobile: 190, fill: "var(--color-destructive)" },
