...
export default function TrafficData() {
  ...
  return (
    <Card className="h-full flex flex-col gap-0 p-0">
      <CardHeader className="py-4 px-6 gap-0">
        <CardTitle>
          <h4 className="text-lg font-medium">Top Selling Products</h4>
        </CardTitle>
      ...
      <CardContent className="flex flex-col justify-between gap-2 h-full p-0">
        <Table>
          <TableHeader className="text-muted-foreground ">
            <TableRow>
              <TableHead className="px-6 text-sm ">
