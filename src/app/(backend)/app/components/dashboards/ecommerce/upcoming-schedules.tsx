...
import { EllipsisVertical, Scooter, TrainFront, Building, MapPin, } from "lucide-react";
                                ...
                                >
                                    <div className="flex items-center justify-between gap-4 sm:flex-nowrap flex-wrap-reverse">
                                        <div className="flex items-center gap-3">
                                            <div className={cn("rounded-xl flex items-center justify-center p-3 shrink-0 border border-border")}>
                                                <event.icons
                                                    width={16}
                                                    height={16}
                                                />
                                        ...
                                        <Badge className="bg-emerald-600/10 text-emerald-600">
                                            {event.key}
                                        </Badge>
                                    </div>
                                    <div className="flex items-center gap-3">
