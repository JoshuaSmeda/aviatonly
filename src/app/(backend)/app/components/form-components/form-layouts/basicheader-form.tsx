  ...
  return (
    <div>
      <TitleCard title="Basic Header Form">
        <div className="pb-6">
          <Alert className="bg-primary/12 text-primary">
            <Info className="h-4 w-4 text-inherit!" />
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="sm:col-span-6 col-span-12">
            ...
            <Select required>
              <SelectTrigger id="gender" className="select-md w-full">
          ...
          <div className="sm:col-span-6 col-span-12">
            ...
            <Select required>
              <SelectTrigger id="country" className="select-md w-full">
