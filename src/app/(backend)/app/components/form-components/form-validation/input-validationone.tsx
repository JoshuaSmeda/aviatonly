          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12">
              ...
              <Input
                ...
                value={formData.name}
              />
              <span className="text-destructive">{errorMessages.name}</span>
            </div>
            ...
            <div className="col-span-12">
              ...
              />
              <span className="text-destructive">{errorMessages.email}</span>
            </div>
            ...
            <div className="col-span-12">
              ...
              />
              <span className="text-destructive">{errorMessages.password}</span>
            </div>
