          ...
          <TableBody>
            {basicTable.basicTableData.map((item, index) => (
              <TableRow key={index}>
                ...
                <TableCell className="whitespace-nowrap">
                  <p className=" text-base text-muted-foreground">{item.pname}</p>
                </TableCell>
                <TableCell className="whitespace-nowrap">
                  <div className="flex ">
                    {item.teams.map((teamtbl, index) => (
                      <div className="-ms-2" key={index}>
                        <div
                          className={`bg-${teamtbl.color} border-2 border-white dark:border-border h-10 w-10 flex justify-center items-center text-xl font-medium text-white rounded-full`}
                        >
                          {teamtbl.text}
                        </div>
                      </div>
