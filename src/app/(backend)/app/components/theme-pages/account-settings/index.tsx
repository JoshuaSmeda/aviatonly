...
import NotificationTab from "@/app/components/theme-pages/account-settings/notification-tab";
import BillsTabs from "@/app/components/theme-pages/account-settings/bills-tab";
import SecurityTab from "@/app/components/theme-pages/account-settings/security-tab";
