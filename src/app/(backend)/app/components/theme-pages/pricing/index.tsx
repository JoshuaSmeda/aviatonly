            ...
            <Card className='relative p-6'>
              {price.badge ? (
                <Badge
                  ...
                  className='uppercase font-bold absolute top-4 end-6 text-chart-4 bg-chart-4/12'>
                  Popular
                </Badge>
              ) : null}
              ...
              <div>
                {price.plan == 'Free' ? (
                  ...
                  <div className='flex'>
                    <small className='text-xl font-bold  -mt-2 me-2'>
                      $
                    </small>
                    {switch1 ? (
                      <>
                        ...
                        <p className='text-base  opacity-70  mt-3 ms-1.5'>
                          /yr
                        </p>
                      </>
                    ) : (
              ...
              <Button className='w-full '>{price.btntext}</Button>
            </Card>
          </div>
        ))}
      </div>
