...
import SwitchActiveEffectDemo from '@/components/dashboard/shadcn-ui/switch/switch-01';
import CodePreview from '@/components/dashboard/shared/code-preview';
import SwitchWithIconDemo from '@/components/dashboard/shadcn-ui/switch/switch-02';
import SwitchToggleThemeDemo from '@/components/dashboard/shadcn-ui/switch/switch-03';
import SwitchWithDescriptionDemo from '@/components/dashboard/shadcn-ui/switch/switch-04';
import SwitchWithNormalLabelDemo from '@/components/dashboard/shadcn-ui/switch/switch-05';
import SwitchCustomColorDemo from '@/components/dashboard/shadcn-ui/switch/switch-06';
