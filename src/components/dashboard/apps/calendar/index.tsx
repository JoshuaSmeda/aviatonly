...
import Events from "@/app/api/calendar/event-data";
...
const CalendarApp = () => {
  ...
  const ColorVariation = [
    ...
    { id: 2, eColor: "chart-2", value: "chart-2" },
    { id: 3, eColor: "destructive", value: "destructive" },
    { id: 4, eColor: "secondary", value: "secondary" },
    { id: 5, eColor: "chart-4", value: "chart-4" },
  ];

  const COLOR_CLASS_MAP: Record<string, string> = {
    primary: "bg-primary",
    "chart-2": "bg-green-500",
