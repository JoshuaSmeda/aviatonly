...
import { ContactType } from "@/app/(dashboard)/dashboard/types/apps/contact";
...
const ContactListItem: React.FC<ContactListItemProps> = ({
  ...
  if (!selectedContact) {
    return (
      <div className="p-6  w-full flex flex-col items-center  text-center">
        <h1 className="text-xl"> Please Select a Contact</h1>
        <Image
  ...
  return (
    <>
                  ...
                  <Tooltip>
                    <TooltipTrigger>
                      <div
                        ...
                        className=" btn-circle-hover hover:bg-destructive/12 hover:text-destructive"
                      >
      ...
      {showAlert && (
        <Alert className="fixed mx-auto start-0 end-0 top-3 w-fit z-50   ">
