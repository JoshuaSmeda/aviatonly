...
import {
  ...
  AnimatedTableBody,
  AnimatedTableRow,
} from "@/components/dashboard/animated-components/animated-table";
import InputPlaceholderAnimate from "@/components/dashboard/animated-components/animatedinput-placeholder";
...
const ProductTablelist = () => {
  ...
  return (
    <>
        ...
        <div className="flex gap-3 justify-between items-center mb-5">
          ...
          <div className="flex gap-4">
            {selectAll ? (
              <Button
                variant={"destructive"}
                className="btn-circle-hover p-0 hover:text-destructive"
                onClick={handleDelete}
              >
                <Icon icon="tabler:trash" height={18} />
              </Button>
            ) : (
              <Button className="btn-circle-hover p-0 bg-primary/5 text-primary hover:text-white dark:hover:text-black">
          ...
          <div className="border rounded-xl border-border overflow-x-auto">
            <AnimatedTableWrapper>
              <Table className="">
                <TableHeader>
                  <TableRow>
                    <TableHead className="text-base font-semibold py-3 cursor-pointer">
                      <Checkbox
                        checked={selectAll}
                    ...
                    {filteredAndSortedProducts.map(
                      (item: ProductType, index: number) => (
                        <AnimatedTableRow key={index} index={index}>
                          ...
                          <TableCell className="whitespace-nowrap">
                            <div className="flex gap-2 text-sm items-center  font-medium text-muted-foreground">
                              {item.stock ? (
                                <Badge className="h-2 w-2 p-0 rounded-md bg-chart-2"></Badge>
                              ) : (
                                <Badge className="h-2 w-2 p-0 rounded-md bg-chart-1"></Badge>
                              )}
            ...
            <div className="grid grid-cols-12 gap-6 pt-4">
              ...
              <div className="col-span-12 lg:col-span-6">
                ...
                >
                  <SelectTrigger id="stck" className="select-md-contact">
                    <SelectValue>
                      {editedProduct.stock ? "In Stock" : "Select Stock Status"}
                    </SelectValue>
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="col-span-12 lg:col-span-6">
                ...
                <DatePicker
                  ...
                  className=" w-full max-w-full py-[10px] border  rounded-md px-3"
                  id="dt"
                />
              </div>
      ...
      {showAlert && (
        <Alert className="fixed top-4 left-1/2 -translate-x-1/2 z-50 max-w-sm w-fit flex items-center gap-2 bg-destructive/12">
          <AlertTitle className="mb-0 text-destructive">
