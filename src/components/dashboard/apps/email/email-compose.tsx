          ...
          <form>
            <div className="grid grid-cols-12 gap-6">
              <div className="col-span-12">
                ...
                <Input type="text" id="to" className="mt-2" />
              </div>
              <div className="col-span-12">
                <Label htmlFor="subject" className="capitalize">
                  Subject
                </Label>
                <Input id="subject" className="mt-2" type="text" />
              </div>
              <div className="col-span-12">
                <Label htmlFor="message" className="capitalize">
                  Message
                </Label>
                <Textarea id="message" className="mt-2" required rows={4} />
              </div>
              <div className="col-span-12">
                <Label htmlFor="attachment" className="capitalize">
                  Attachment
                </Label>
                <Input type="file" id="attachment" className="mt-2" />
              </div>
              <div className="col-span-12">
