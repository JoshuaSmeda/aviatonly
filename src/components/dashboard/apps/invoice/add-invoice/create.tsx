...
import { order } from "@/app/(dashboard)/dashboard/types/apps/invoice";
    ...
    <div>
      ...
      <form>
        <div>
          <div className="grid grid-cols-12 gap-6">
            <div className="lg:col-span-6 md:col-span-6 col-span-12">
              ...
              <div className="p-4 bg-muted dark:bg-muted/50 border border-border rounded-xl">
              ...
              <div className="py-5">
                ...
                <Popover>
                  <PopoverTrigger className={"w-full"} disabled>
                    <Button
                      variant="outline"
                      className={` w-full justify-start text-left font-normal border border-border hover:bg-transparent hover:border-primary  ${!date ? "text-muted hover:text-muted-foreground" : ""
                        }`}
                      disabled
                    >
            ...
            <div className="lg:col-span-6 md:col-span-6 col-span-12">
              ...
              <div className="p-4 bg-muted dark:bg-muted/50 border border-border rounded-xl flex flex-col gap-1">
                <div className="flex justify-between items-start gap-2">
                  {editModeTo ? (
                    <div className="flex flex-col gap-1 flex-1">
                      <Input
              ...
              <div className="py-5">
                ...
                <Popover>
                  <PopoverTrigger className={"w-full"}>
                    <Button
                      variant="outline"
                      className=" w-full justify-start text-left font-normal border border-border hover:bg-transparent hover:border-primary text-muted-foreground hover:text-muted-foreground"
                    >
                      {formData.dueDate
        ...
        <div className="mt-6">
          <div className="overflow-x-auto overflow-y-hidden">
            <div className="mt-4 mb-10 border border-border rounded-xl">
              <Table>
                <TableHeader>
                  <TableRow>
                ...
                <TableBody className="divide-y divide-border">
                  {formData.orders.map((order, index) => (
                    <TableRow key={index}>
                      {/* Item Name */}
                      <TableCell className="whitespace-nowrap min-w-44 px-5">
                        <Input
                          type="text"
                          ...
                          <Tooltip>
                            <TooltipTrigger>
                              <Button
                                type="button"
                                className={
                                  "text-primary bg-primary/5 hover:bg-primary/30 "
                                }
                                size="icon"
        ...
        <div className="p-4 bg-muted dark:bg-muted/50 border border-border rounded-xl flex flex-col gap-1">
          <div className="flex justify-end mb-3">
            <div className="flex gap-3 lg:w-1/5">
              <h2 className="max-w-52 w-full text-muted-foreground font-normal">
                Sub Total:
              </h2>
              <h3 className="ms-auto  text-muted-foreground font-normal">
                ${formData.subtotal}
              </h3>
            </div>
          </div>
          <div className="flex justify-end mb-3">
            <div className="flex gap-3 lg:w-1/5 border-b border-border">
              <h2 className="max-w-52 w-full text-muted-foreground font-normal">
                Tax:
              </h2>
              <h3 className="ms-auto text-muted-foreground font-normal">
      ...
      {showAlert && (
        <div className="flex items-center justify-center">
          <Alert className="max-w-sm w-full text-center fixed top-16 rounded bg-chart-2 text-white border-chart-2">
