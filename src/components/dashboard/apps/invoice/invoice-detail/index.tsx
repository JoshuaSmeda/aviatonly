...
import { InvoiceList } from "@/app/(dashboard)/dashboard/types/apps/invoice";
    ...
    <>
      ...
      <div className="p-2  ">
        <div className="flex items-center gap-3 flex-wrap">
          <div className="sm:border-e sm:border-border sm:pe-3">
            <Button
              variant={"ghost"}
          ...
          <div className="sm:border-e sm:border-border sm:pe-3">
            <Button
              variant={"ghost"}
              className="flex items-center gap-2 text-sm font-medium hover:bg-primary/5 hover:text-primary"
      ...
      <div ref={contentRef}>
        ...
        <div className="overflow-x-auto">
          <div className="mb-10 border border-border !rounded-xl">
            <Table>
              <TableHeader>
                <TableRow >
          ...
          <div className="p-4 bg-muted dark:bg-muted/50 border border-border rounded-xl flex flex-col gap-1">
            <div className="flex justify-end mb-3">
              <div className="flex gap-3 lg:w-1/5">
                ...
                <h3 className="ms-auto text-base text-muted-foreground  font-normal">
