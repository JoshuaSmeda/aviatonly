      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12">
            ...
            >
              <SelectTrigger className="w-full cursor-pointer" id="askProperty-label">
                <SelectValue>
              ...
              <SelectContent>
                {TaskProperties.map((property) => (
                  <SelectItem className={"cursor-pointer"} key={property} value={property}>
                    {property}
                  </SelectItem>
                ))}
              </SelectContent>
        ...
        <DialogFooter className="mt-6">
          <Button variant="destructive" onClick={onHide}>
            Cancel
          </Button>
          <Button
            onClick={handleSave}
