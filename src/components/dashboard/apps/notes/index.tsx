...
import NotesSidebar from "@/components/dashboard/apps/notes/notes-sidebar";
import NoteContent from "@/components/dashboard/apps/notes/note-content";
import AddNotes from "@/components/dashboard/apps/notes/add-notes";
