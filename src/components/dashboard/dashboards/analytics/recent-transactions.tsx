...
export default function RecentTransactions() {
    ...
    return (
        <div ref={ref} className="h-full">
            <Card className="w-full gap-6 py-6 justify-between h-full">
                {/* Header */}
                    ...
                    {paymentGateways.map((item, index) => (
                        ...
                        >
                            <div className="flex gap-3 items-center">
                                <div
                                    className={`rounded-md flex items-center justify-center h-11 w-11 border border-border`}
                                >
                                    <img
                                        src={item.paymentImg}
                ...
                <CardFooter className="px-6 pt-0 pb-0 border-0 bg-card">
                    <Button className="w-full py-2 h-auto rounded-lg cursor-pointer">
                        View full report
                    </Button>
                </CardFooter>
            </Card>
