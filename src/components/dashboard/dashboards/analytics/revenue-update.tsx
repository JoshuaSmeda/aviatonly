                ...
                <div className="grid grid-cols-12 items-center gap-6">
                    ...
                    <div className="lg:col-span-4 md:col-span-4 sm:col-span-12 col-span-12">
                        <div className="flex items-center gap-3">
                            <div className="shrink-0 h-10 w-10 flex justify-center items-center rounded-md border border-border">
                                <Grip className="text-xl text-primary" />
                            </div>
                            <div>
                        ...
                        <Button className="h-auto py-2 px-4 mt-9 sm:mt-14 rounded-lg capitalize w-full cursor-pointer hover:bg-primary/80">view full report</Button>
                    </div>
                </div>
            </CardContent>
        </Card>
