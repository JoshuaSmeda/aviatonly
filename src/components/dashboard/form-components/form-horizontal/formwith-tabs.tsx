        ...
        <div className="overflow-x-auto">
          <Tabs defaultValue="personal" className="gap-6">
            <TabsList className="mb-6">
              ...
              <TabsTrigger className="cursor-pointer" value="account">Account Details</TabsTrigger>
              <TabsTrigger className="cursor-pointer" value="social">Social Links</TabsTrigger>
            </TabsList>
                      ...
                      <Popover>
                        <PopoverTrigger className={"w-full"}>
                          <Button
                            variant="outline"
                            className={cn(
                              "w-full justify-start text-left font-normal border-border hover:border-primary hover:bg-transparent ",
                              !date &&
