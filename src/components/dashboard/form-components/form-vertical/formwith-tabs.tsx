      ...
      <TitleCard title="Form with Tabs">
        <Tabs defaultValue="personal-info" className="gap-6">
          <TabsList className="mb-6">
            <TabsTrigger className="cursor-pointer" value="personal-info">Personal Info</TabsTrigger>
            <TabsTrigger className="cursor-pointer" value="account-details">Account Details</TabsTrigger>
            <TabsTrigger className="cursor-pointer" value="social-links">Social Links</TabsTrigger>
          </TabsList>
                  ...
                  <Popover>
                    <PopoverTrigger className={"w-full"}>
                      <Button
                        variant="outline"
                        className={cn(
                          "w-full justify-start text-left font-normalborder-border hover:border-primary hover:bg-transparent ",
                          !date &&
