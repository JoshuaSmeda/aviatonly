          ...
          <div className="space-y-4">
            ...
            <FieldGroup>
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="form-rhf-demo-address.street">
                      Street Address
                    </FieldLabel>
                    <Input
                      {...field}
                      id="form-rhf-demo-address.street"
                      aria-invalid={fieldState.invalid}
              ...
              <div className="grid grid-cols-2 gap-4">
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <FieldLabel htmlFor="form-rhf-demo-address.city">
                        City
                      </FieldLabel>
                      <Input
                        {...field}
                        id="form-rhf-demo-address.city"
                        aria-invalid={fieldState.invalid}
                        placeholder="Anytown"
                        autoComplete="off"
                      />
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <FieldLabel htmlFor="form-rhf-demo-address.zipCode">
                        ZIP Code
                      </FieldLabel>
                      <Input
                        {...field}
                        id="form-rhf-demo-address.zipCode"
                        aria-invalid={fieldState.invalid}
                        placeholder="12345"
                        autoComplete="off"
                      />
            ...
            {fields.map((item, index) => (
              <Card key={item.id} className="p-4">
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Subtotal: $
                  {getSubtotal(form.getValues(`cartItems.${index}`)).toFixed(2)}
                </p>
              </Card>
            ))}
                ...
                <Field className="space-y-3">
                  ...
                  >
                    ...
                    <Field className="flex items-center space-x-3 space-y-0">
                      ...
                      <FieldLabel className="font-normal">PayPal</FieldLabel>
                    </Field>
                    <Field className="flex items-center space-x-3 space-y-0">
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <p>
                  <strong>Email:</strong> {form.getValues("customerInfo.email")}
                </p>
                <p>
                  <strong>Phone:</strong> {form.getValues("customerInfo.phone")}
                </p>
                <p>
