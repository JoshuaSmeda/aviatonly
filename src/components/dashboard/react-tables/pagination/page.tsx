    ...
    cell: (info) => (
      <div className="flex gap-2">
        {info.getValue().map((course, index) => (
          <Badge
            key={index}
            className={`capitalize   bg-${course.statuscolor}`}
          >
            {course.status}
          </Badge>
        ))}
        ...
        <div className="border rounded-md border-border overflow-hidden">
                ...
                {table.getHeaderGroups().map((headerGroup) => (
                  <tr key={headerGroup.id}>
                    {headerGroup.headers.map((header) => (
                      <th
                        key={header.id}
                        className="text-base  font-semibold py-3 text-left border-b border-border px-4"
                      >
          ...
          <div className="sm:flex  gap-2 p-3 items-center justify-between">
            <div className="flex items-center gap-2">
              <Button onClick={() => rerender()} className={"text-white"}>
                Force Rerender
              </Button>
            ...
            <div className="sm:flex  items-center gap-2 sm:mt-0 mt-3">
              <div className="sm:flex items-center gap-2">
                <div className="flex ">
                  <h2 className="text-muted-foreground pe-1">Page</h2>
                ...
                <div className="flex items-center gap-2 text-muted-foreground">
                  ...
                  <Input
                    ...
                    className="w-16   py-2! px-4!"
                  />
                </div>
                <div className="select-md sm:mt-0 mt-3 text-muted-foreground">
                  <Select
                ...
                <div className="flex gap-2 sm:mt-0 mt-3">
                  <Button
                    ...
                    className="bg-muted text-foreground hover:bg-primary/5  disabled:opacity-50"
                  >
