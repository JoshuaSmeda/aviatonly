    ...
    >
      ...
      >
        ...
        {showReplayButton && (
          <button
            onClick={onReplay}
            className="text-xs py-1 px-2 rounded-full border border-dark/15 dark:border-white/20 hover:border-primary/12  hover:bg-primary/5  flex items-center gap-1"
          >
            <Icon
        ...
        <TooltipProvider>
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="text-xs py-1 px-1.5 rounded-full border border-dark/15 dark:border-white/20 hover:border-primary/12 hover:bg-primary/5 "
            >
