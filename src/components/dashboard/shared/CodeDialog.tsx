...
const CodeDialog = ({ children }: { children: string }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h5
          className={`text-base  font-semibold ${isOpen ? "block" : "hidden"}`}
        >
          Sample Code
        </h5>
        <TooltipProvider>
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="text-xs py-1 px-1.5 rounded-full border border-border  hover:border-primary/12  hover:bg-primary/5 cursor-pointer "
            >
