...
import NotificationTab from "@/components/dashboard/theme-pages/account-settings/notification-tab";
import BillsTabs from "@/components/dashboard/theme-pages/account-settings/bills-tab";
import SecurityTab from "@/components/dashboard/theme-pages/account-settings/security-tab";
    ...
    <Card className="px-0 py-0">
      <Tabs defaultValue="account" className="w-full">
        <TabsList className="w-full justify-start pl-4">
          ...
          <TabsTrigger value="notification" className="flex items-center gap-2 cursor-pointer">
            <Icon icon="tabler:bell" height={20} />
            Notification
          </TabsTrigger>
          <TabsTrigger value="bills" className="flex items-center gap-2 cursor-pointer">
