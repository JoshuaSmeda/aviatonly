            ...
            <DialogContent className="max-w-xl">
                ...
                <div className="mt-6">
                    {authDetails.map((item, idx) => (
                        <div
                            key={idx}
                            className="grid grid-cols-1 sm:grid-cols-3 gap-2 py-4 border-b border-border "
                        >
                            <p className="text-muted-foreground">{item.label}</p>
                            <p className=" text-sm font-medium break-all text-muted-foreground">{item.value}</p>
                        </div>
                    ))}
                </div>
            </DialogContent>
