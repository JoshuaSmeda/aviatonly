...
export function mapListingRecord(listing: AircraftListing): MockAircraftListing {
  return {
    ...
    platformIndicativeValue: listing.platformIndicativeValue,
    askingPrice: listing.askingPrice,
    reservePrice: listing.reservePrice,
    startingBid: listing.startingBid,
    bidIncrement: listing.bidIncrement,
    inspectionProvider: listing.inspectionProvider,
    inspectionLocation: listing.inspectionLocation,
    inspectionScheduledAt: listing.inspectionScheduledAt?.toISOString() ?? null,
    inspectionNotes: listing.inspectionNotes,
    inspectionCompletedAt: listing.inspectionCompletedAt?.toISOString() ?? null,
